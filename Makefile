...
fetchDep:
	-go get  github.com/gitamenet/V2RayConfigureFileUtil
	-cd $(GOPATH)/src/github.com/gitamenet/V2RayConfigureFileUtil;$(MAKE) all
	go get  github.com/gitamenet/V2RayConfigureFileUtil
	-go get  github.com/gitamenet/AndroidLibV2ray
	-cd $(GOPATH)/src/github.com/gitamenet/libV2RayAuxiliaryURL; $(MAKE) all
	-go get  github.com/gitamenet/AndroidLibV2ray
	-cd $(GOPATH)/src/github.com/gitamenet/waVingOcean/configure; $(MAKE) pb
	go get github.com/gitamenet/AndroidLibV2ray
...
gomobile init ;gomobile bind -v  -tags json github.com/gitamenet/AndroidLibV2ray
#buildVGO:
